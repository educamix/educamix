...
export default function Admin() {
  ...
  const changeUserRole = async (
    { id, newRole }: { id?: string, newRole: TUserRole },
  ) => {
    if (!id) return
              ...
              <tr key={user._id}>
                ...
                <td className="py-2 px-4 border-b">
                  <button
                    ...
                    className={`bg-blue-500 text-white px-2 py-1 rounded mr-2 ${user.role === 'teacher'
...
: ''}`}
                  ...
                  <button
                    ...
                    className={`bg-green-500 text-white px-2 py-1 rounded mr-2 ${user.role === 'student'
? 'opacity-50 cursor-not-allowed'
: ''}`}
                    disabled={user.role !== 'teacher'}
                  >
